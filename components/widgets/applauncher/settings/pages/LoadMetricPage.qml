...
VabContentPage {
    ...
    readonly property string metricKey: "Load"
    readonly property string metricLabel: "LOAD"
    readonly property string metricValue: sysSvc ? sysSvc.loadAvg1 : "0.00"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 1140
