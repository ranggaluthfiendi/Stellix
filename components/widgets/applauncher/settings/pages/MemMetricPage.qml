...
VabContentPage {
    ...
    property int currentCategory: 16
    ...
    readonly property string metricKey: "Mem"
    readonly property string metricLabel: "RAM"
    readonly property string metricValue: sysSvc ? (Math.round(sysSvc.memUsed / 1024) + " GB") : "0 GB"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 240
