...
VabContentPage {
    ...
    property int currentCategory: 18
    ...
    readonly property string metricKey: "Uptime"
    readonly property string metricLabel: "UPTIME"
    readonly property string metricValue: sysSvc && sysSvc.uptime ? sysSvc.uptime : "0d 0h"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 440
