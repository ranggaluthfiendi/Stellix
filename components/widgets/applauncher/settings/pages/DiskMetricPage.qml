...
VabContentPage {
    ...
    property int currentCategory: 17
    ...
    readonly property string metricKey: "Disk"
    readonly property string metricLabel: "DISK"
    readonly property string metricValue: sysSvc && sysSvc.diskUsage ? sysSvc.diskUsage : "0%"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 340
