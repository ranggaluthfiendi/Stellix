...
VabContentPage {
    id: page
    property int currentCategory: 24
    ...
    readonly property string metricKey: "GpuMem"
    readonly property string metricLabel: "GPU MEM"
    readonly property string metricValue: sysSvc && sysSvc.gpuMemTotal > 0 ? (Math.round(sysSvc.gpuMemUsage) + "%") : "N/A"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 1040
