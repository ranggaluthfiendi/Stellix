...
VabContentPage {
    ...
    property int currentCategory: 15
    ...
    readonly property string metricKey: "Gpu"
    readonly property string metricLabel: "GPU"
    readonly property string metricValue: {
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 140
