...
VabContentPage {
    ...
    property int currentCategory: 19
    ...
    readonly property string metricKey: "Temp"
    readonly property string metricLabel: "TEMP"
    readonly property string metricValue: sysSvc && sysSvc.temperature ? sysSvc.temperature : "0°C"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 540
