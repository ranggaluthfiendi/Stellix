...
VabContentPage {
    id: page
    property int currentCategory: 28
    ...
    readonly property string metricKey: "Ip"
    readonly property string metricLabel: "IP"
    readonly property string metricValue: sysSvc ? sysSvc.ipAddress : "N/A"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 1440
