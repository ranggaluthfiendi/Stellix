...
VabContentPage {
    id: page
    property int currentCategory: 22
    ...
    readonly property string metricKey: "Swap"
    readonly property string metricLabel: "SWAP"
    readonly property string metricValue: sysSvc ? (Math.round(sysSvc.swapUsage) + "%") : "0%"
    ...
    ColumnLayout {
        ...
        VabSettingsCard {
            ...
            headerActions: VabButton {
                text: "Reset Position"
                onClicked: {
                    BarLayoutState["desktop" + page.metricKey + "X"] = 940
