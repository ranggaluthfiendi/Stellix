...
PanelWindow {
    ...
    visible: RightBarState.settingsOpen
    color: "transparent"
    ...
    WlrLayershell.keyboardFocus: RightBarState.settingsOpen ? WlrKeyboardFocus.Exclusive : WlrKeyboardFocus.None
    ...
    MouseArea {
        anchors.fill: parent
        onClicked: { RightBarState.settingsOpen = false; root.recordingTarget = ""; root.isRecording = false }
    }
    ...
    Rectangle {
        ...
        opacity: RightBarState.settingsOpen ? 1 : 0
        scale: RightBarState.settingsOpen ? 1 : 0.97
        ...
        RowLayout {
            ...
            Rectangle {
                id: sidebar
                Layout.fillHeight: true; Layout.preferredWidth: Theme.dp(220); color: Theme.bgSecondary
                ColumnLayout {
                    anchors.fill: parent; anchors.margins: Theme.dp(16); spacing: Theme.dp(6)
                    RowLayout {
